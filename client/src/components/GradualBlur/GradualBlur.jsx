...
const PRESETS = {
  top: { position: 'top', height: '6rem', divCount: 2 },
  bottom: { position: 'bottom', height: '6rem', divCount: 2 },
  left: { position: 'left', height: '6rem', divCount: 2 },
  right: { position: 'right', height: '6rem', divCount: 2 },
  subtle: { height: '4rem', strength: 1, opacity: 0.8, divCount: 2 },
  intense: { height: '10rem', strength: 4, divCount: 4, exponential: true },
  smooth: { height: '8rem', curve: 'bezier', divCount: 4 },
  sharp: { height: '5rem', curve: 'linear', divCount: 3 },
  header: { position: 'top', height: '8rem', curve: 'ease-out', divCount: 3 },
  footer: { position: 'bottom', height: '8rem', curve: 'ease-out', divCount: 3 },
  sidebar: { position: 'left', height: '6rem', strength: 2.5, divCount: 3 },
  'page-header': { position: 'top', height: '10rem', target: 'page', strength: 3, divCount: 3 },
  'page-footer': { position: 'bottom', height: '10rem', target: 'page', strength: 3, divCount: 3 }
};
