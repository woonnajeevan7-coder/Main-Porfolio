...
export function LocationMap({
  ...
  return (
    ...
    >
        ...
        <div className="relative z-10 h-full flex flex-col justify-between p-4">
          ...
          <div className="flex items-start justify-between">
            ...
            >
              ...
              <span className="text-[8px] font-bold text-slate-500 tracking-wide uppercase">Live</span>
            </motion.div>
          </div>
          ...
          <div className="space-y-0.5">
            <motion.h3
              className="text-slate-800 font-bold text-xs tracking-tight"
              animate={{
                x: isHovered ? 4 : 0,
              }}
            ...
            {/* Animated underline */}
            <motion.div
              className="h-0.5 bg-gradient-to-r from-emerald-500/50 via-emerald-400/30 to-transparent"
      ...
      {/* Click hint */}
      <motion.p
        className="absolute -bottom-5 left-1/2 text-[8px] font-bold text-slate-400 whitespace-nowrap uppercase tracking-tighter"
        style={{ x: "-50%" }}
        initial={{ opacity: 0 }}
        animate={{
